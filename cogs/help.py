...
class help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name="Command: upload", value="Uploads your animal picture, must have the file extension of png, jpg, or gif", inline=False)
        embed.add_field(name="Command: pic", value="Returns a random picture from animal pictures that have been uploaded optionally you can specify a pictures id", inline=False)
