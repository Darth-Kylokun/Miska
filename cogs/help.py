...
class help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name="Sub-Command of upload: t", value="Add a tag to your pictue to allow it to be searched by tag, tag also must be whitelisted", inline=False)
