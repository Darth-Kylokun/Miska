...
class help(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name="Sub-Command of upload: tag", value="Add a tag to your pictue to allow it to be searched by tag, tag also must be whitelisted", inline=False)
        embed.add_field(name="Command: pic", value="Returns a random picture from uploaded animal pictures", inline=False)
        ...
        embed.add_field(name="Command: tags", value="Sends list of all whitelisted tags", inline=False)
